...
//write a arrow function with input value 'javaScipt' and will return the total number characters
const totalNumChar = (str) => {
  let totalChar = str.length;
  return totalChar;
};
const result = totalNumChar("javaScript");
